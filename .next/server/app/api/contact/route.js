      ...
      9967: (t, e, i) => {
        ...
        async function c(t) {
          try {
            ...
            let s = p.createTransport({
                service: 'gmail',
                auth: {
                  user: 'hydroleaf.ad@gmail.com',
                  pass: 'wmzmobsmbhphdgmd',
                },
              }),
              n = {
                from: i,
                to: process.env.GMAIL_USER,
                subject: `New Contact Form Submission from ${e}`,
                text: `Name: ${e}
Email: ${i}
...
${a}`,
              ...
              o = await s.sendMail(n);
            return (
              console.log('Email sent:', o.response),
              r.NextResponse.json(
                { success: !0, message: 'Email sent successfully!' },
                { status: 200 }
              )
            );
          } catch (t) {
            return (
              console.error('Email sending error:', t),
              r.NextResponse.json(
                {
                  error:
                    t instanceof Error ? t.message : 'Failed to send email',
                },
                { status: 500 }
              )
            );
        ...
        let l = new s.AppRouteRouteModule({
          ...
          { workAsyncStorage: d, workUnitAsyncStorage: m, serverHooks: h } = l;
        function u() {
      ...
      525: (t) => {
        ...
        class e {
          ...
          tokenize() {
            let t = [];
            for (let t = 0, e = this.str.length; t < e; t++) {
              let i = this.str.charAt(t),
                a = t < e - 1 ? this.str.charAt(t + 1) : null;
              this.checkChar(i, a);
            }
            return (
              this.list.forEach((e) => {
          ...
          checkChar(t, e) {
            if (this.escaped);
            else if (t === this.operatorExpecting) {
              (this.node = { type: 'operator', value: t }),
                ...
                (this.escaped = !1);
              return;
            } else if (!this.operatorExpecting && t in this.operators) {
              (this.node = { type: 'operator', value: t }),
                this.list.push(this.node),
                (this.node = null),
                  ...
                  if ('operator' === t.type)
                    ...
                    t.value &&
                      ...
                      i && i.noBreak && p[o].length
                        ? (p[o][p[o].length - 1] += t.value)
                        : p[o].push(t.value));
                }
                if (
                  (!p.text.length &&
                    p.comment.length &&
                    ((p.text = p.comment), (p.comment = [])),
                  n)
                )
                  (p.text = p.text.join(' ')),
                    r.push({
                      name: p.text || (i && i.name),
                      group: p.group.length ? t(p.group.join(',')) : [],
                    });
                else {
                  if (!p.address.length && p.text.length) {
                    for (a = p.text.length - 1; a >= 0; a--)
                      if (p.text[a].match(/^[^@\s]+@[^@\s]+$/)) {
                        p.address = p.text.splice(a, 1);
                        break;
                      }
                    let t = function (t) {
                      return p.address.length
                        ? t
                        : ((p.address = [t.trim()]), ' ');
                    };
                    if (!p.address.length)
                  ...
                  if (
                    (!p.text.length &&
                      ...
                      ((p.text = p.comment), (p.comment = [])),
                    p.address.length > 1 &&
                      (p.text = p.text.concat(p.address.splice(1))),
                    (p.text = p.text.join(' ')),
                    (p.address = p.address.join(' ')),
                    !p.address && n)
                  )
                    return [];
                  (i = {
                    address: p.address || p.text || '',
                    name: p.text || p.address || '',
                  }).address === i.name &&
                    ((i.address || '').match(/@/)
                      ? (i.name = '')
                      : (i.address = '')),
      ...
      301: (t, e, i) => {
        ...
        function n(t, e) {
          if (((t = (t || '').toString()), (e = e || 76), t.length <= e))
            return t;
          let i = [],
            a = 0,
            s = 1024 * e;
          ...
          _transform(t, e, i) {
            ...
            (this.inputBytes += t.length),
              ...
              t.length % 3
                ...
                : (this._remainingBytes = !1);
            let a = this._curLine + s(t);
            if (this.options.lineLength) {
              let t = (a = n(a, this.options.lineLength)).lastIndexOf('\n');
              t < 0
                ? ((this._curLine = a), (a = ''))
                : t === a.length - 1
                  ? (this._curLine = '')
                  : ((this._curLine = a.substr(t + 1)),
                    (a = a.substr(0, t + 1)));
            }
            a &&
              ((this.outputBytes += a.length),
              this.push(Buffer.from(a, 'ascii'))),
              setImmediate(i);
          }
          _flush(t) {
            this._remainingBytes &&
              this._remainingBytes.length &&
              (this._curLine += s(this._remainingBytes)),
              this._curLine &&
                ((this._curLine = n(this._curLine, this.options.lineLength)),
      ...
      8041: (t, e, i) => {
        ...
        class l {
          constructor(t, e, i, a) {
            (this.options = t || {}),
              (this.keys = e),
              (this.cacheTreshold =
                Number(this.options.cacheTreshold) || 131072),
              (this.hashAlgo = this.options.hashAlgo || 'sha256'),
              ...
              this.input.on('error', (t) => {
                (this.hasErrored = !0), this.cleanup(), a.emit('error', t);
              });
          }
          cleanup() {
          ...
          createReadCache() {
            (this.cache = r.createReadStream(this.cachePath)),
          ...
          sendSignedOutput() {
            let t = 0,
              e = () => {
                ...
                let i = this.keys[t++],
                  a = n(this.headers, this.hashAlgo, this.bodyHash, {
                ...
                return (
                  a && this.output.write(Buffer.from(a + '\r\n')),
                  setImmediate(e)
                );
              };
          ...
          createWriteCache() {
            (this.output.usingCache = !0),
              (this.cache = r.createWriteStream(this.cachePath)),
              this.cache.once('error', (t) => {
                this.cleanup(),
          ...
          signStream() {
            (this.parser = new a()),
              (this.relaxedBody = new s({ hashAlgo: this.hashAlgo })),
        ...
        class d {
          ...
          sign(t, e) {
            ...
            Buffer.isBuffer(t)
              ? ((s = t), (a = new o()))
              : 'string' == typeof t && ((s = Buffer.from(t)), (a = new o()));
            let n = this.options;
            e &&
      ...
      7571: (t, e, i) => {
        ...
        class s extends a {
          ...
          updateLastBytes(t) {
            ...
            for (let t = 0, a = e - i; t < a; t++)
              this.lastBytes[t] = this.lastBytes[t + i];
            for (let a = 1; a <= i; a++)
              this.lastBytes[e - a] = t[t.length - a];
          }
          checkHeaders(t) {
            ...
            let e = this.lastBytes.length,
              i = 0;
            this.curLinePos = 0;
            for (let a = 0, s = this.lastBytes.length + t.length; a < s; a++)
              if (10 === (a < e ? this.lastBytes[a] : t[a - e]) && a) {
                let s = a - 1 < e ? this.lastBytes[a - 1] : t[a - 1 - e],
                  n =
                    a > 1 && (a - 2 < e ? this.lastBytes[a - 2] : t[a - 2 - e]);
                if (10 === s || (13 === s && 10 === n)) {
          ...
          _transform(t, e, i) {
            ...
            try {
              a = this.checkHeaders(t);
            } catch (t) {
              return i(t);
            }
            a && ((this.bodySize += t.length), this.push(t)), setImmediate(i);
          }
          _flush(t) {
        ...
        class n extends a {
          constructor(t) {
            super(),
              ...
              (this.bodyHash = s.createHash(t.hashAlgo || 'sha1')),
              (this.remainder = ''),
              (this.byteLength = 0),
              (this.debug = t.debug),
          ...
          updateHash(t) {
            ...
            for (let e = t.length - 1; e >= 0; e--) {
              let s = t[e];
              if ('file' === a && (10 === s || 13 === s));
              else if ('file' === a && (9 === s || 32 === s)) a = 'line';
              else if ('line' === a && (9 === s || 32 === s));
              else if (
                ('file' === a || 'line' === a) &&
                ((a = 'body'), e === t.length - 1)
              )
              ...
              if (0 === e) {
                if (
                  ...
                  this.remainder += t.toString('binary');
                  return;
                }
                if ('line' === a || 'file' === a) {
        ...
        function o(t, e, i) {
          ...
          (i || '')
            ...
            (e || '')
              .toLowerCase()
              .split(':')
              .filter((t) => !s.has(t.trim()))
              .forEach((t) => {
                a.add(t.trim());
              });
          for (let e = t.length - 1; e >= 0; e--) {
            let i = t[e];
            a.has(i.key) && !n.has(i.key) && n.set(i.key, r(i.line));
          }
          let o = [],
            p = [];
          return (
            a.forEach((t) => {
              n.has(t) && (p.push(t), o.push(t + ':' + n.get(t)));
            }),
            { headers: o.join('\r\n') + '\r\n', fieldNames: p.join(':') }
          );
        }
        ...
        (t.exports = (t, e, i, p) => {
          ...
          let d = o(
            ...
            m = (function (t, e, i, n, o) {
              ...
              return s.foldLines('DKIM-Signature: ' + r, 76) + ';\r\n b=';
            })(p.domainName, p.keySelector, d.fieldNames, e, i);
          (d.headers += 'dkim-signature:' + r(m)),
            (c = n.createSign(('rsa-' + e).toUpperCase())).update(d.headers);
          try {
            l = c.sign(p.privateKey, 'base64');
          } catch (t) {
            return !1;
          }
          return m + l.replace(/(^.{73}|.{75}(?!\r?\n|\r))/g, '$&\r\n ').trim();
        }),
        ...
        class s {
          ...
          set(t, e) {
            ...
            return (
              n.domain
                ? ((i = n.domain.replace(/^\./, '')),
                  (s.hostname.length < i.length ||
                    ('.' + s.hostname).substr(-i.length + 1) !== '.' + i) &&
                    (n.domain = s.hostname))
                : (n.domain = s.hostname),
              n.path || (n.path = this.getPath(s.pathname)),
              n.expires ||
                (n.expires = new Date(
                  Date.now() +
                    1e3 * (Number(this.options.sessionTimeout || 1800) || 1800)
                )),
              this.add(n)
            );
          }
          ...
          list(t) {
            ...
            for (e = this.cookies.length - 1; e >= 0; e--) {
              if (((i = this.cookies[e]), this.isExpired(i))) {
                this.cookies.splice(e, e);
                continue;
              }
              this.match(i, t) && a.unshift(i);
            }
            return a;
          }
          parse(t) {
            ...
            return (
              (t || '')
                ...
                .forEach((t) => {
                  let i,
                    a = t.split('='),
                    s = a.shift().trim().toLowerCase(),
                    n = a.join('=').trim();
                  if (s)
                    switch (s) {
                      case 'expires':
                        'Invalid Date' !== (n = new Date(n)).toString() &&
                          (e.expires = n);
                        break;
                      case 'path':
                        e.path = n;
          ...
          add(t) {
            ...
            for (e = 0, i = this.cookies.length; e < i; e++)
              if (this.compare(this.cookies[e], t)) {
                if (this.isExpired(t)) return this.cookies.splice(e, 1), !1;
                return (this.cookies[e] = t), !0;
              }
      ...
      9974: (t, e, i) => {
        ...
        (t.exports = function (t, e) {
          return (function t(e, i) {
            let d, m, h;
            ((i = i || {}).fetchRes = i.fetchRes || new r()),
              (i.cookies = i.cookies || new p()),
              (i.redirects = i.redirects || 0),
              (i.maxRedirects = isNaN(i.maxRedirects) ? 5 : i.maxRedirects),
              i.cookie &&
            ...
            let u = i.fetchRes,
              x = n.parse(e),
              f = (i.method || '').toString().trim().toUpperCase() || 'GET',
              g = !1,
              v = 'https:' === x.protocol ? s : a,
              b = {
            ...
            if (
              (Object.keys(i.headers || {}).forEach((t) => {
                b[t.toLowerCase().trim()] = i.headers[t];
              }),
              i.userAgent && (b['user-agent'] = i.userAgent),
              x.auth &&
                (b.Authorization =
                  'Basic ' + Buffer.from(x.auth).toString('base64')),
              (d = i.cookies.get(e)) && (b.cookie = d),
              i.body)
            ) {
              if (
                (!1 !== i.contentType &&
                ...
                if (i.body instanceof Buffer) m = i.body;
                ...
                else m = Buffer.from(i.body.toString().trim());
                (b['Content-Type'] =
                  i.contentType || 'application/x-www-form-urlencoded'),
                  (b['Content-Length'] = m.length);
              }
              f = (i.method || '').toString().trim().toUpperCase() || 'POST';
            }
            let y = {
              method: f,
              host: x.hostname,
              path: x.path,
              port: x.port ? x.port : 'https:' === x.protocol ? 443 : 80,
              headers: b,
            ...
            return (
              i.timeout &&
                h.setTimeout(i.timeout, () => {
                  if (g) return;
                  (g = !0), h.abort();
                  let t = Error('Request Timeout');
                  (t.type = 'FETCH'), (t.sourceUrl = e), u.emit('error', t);
                }),
              h.on('error', (t) => {
                g ||
                ...
                if (!g) {
                  ...
                  if (
                    (a.headers['set-cookie'] &&
                      [].concat(a.headers['set-cookie'] || []).forEach((t) => {
                        i.cookies.set(t, e);
                      }),
                    [301, 302, 303, 307, 308].includes(a.statusCode) &&
                      a.headers.location)
                  ) {
                    if ((i.redirects++, i.redirects > i.maxRedirects)) {
                      g = !0;
                      let t = Error('Maximum redirect count exceeded');
                      (t.type = 'FETCH'),
                        (t.sourceUrl = e),
                        u.emit('error', t),
                        h.abort();
                    ...
                    return (
                      (i.method = 'GET'),
                      (i.body = !1),
                      t(n.resolve(e, a.headers.location), i)
                    );
                  }
                  if (
                    ((u.statusCode = a.statusCode),
                    (u.headers = a.headers),
                    a.statusCode >= 300 && !i.allowErrorResponse)
                  ) {
                    g = !0;
                    let t = Error('Invalid status code ' + a.statusCode);
                    (t.type = 'FETCH'),
                      (t.sourceUrl = e),
                      u.emit('error', t),
                      h.abort();
              ...
              setImmediate(() => {
                if (m)
                  try {
                    if ('function' == typeof m.pipe) return m.pipe(h);
                    h.write(m);
                  } catch (t) {
                    (g = !0),
                      (t.type = 'FETCH'),
        ...
        class n {
          ...
          send(t, e) {
            ...
            let i = t.data.envelope || t.message.getEnvelope(),
              ...
              s = [].concat(i.to || []);
            s.length > 3 && s.push('...and ' + s.splice(2).length + ' more'),
              this.logger.info(
        ...
        class o {
          ...
          compile() {
            return (
              ...
              this.mail.raw
                ? (this.message = new a('message/rfc822', {
          ...
          getAttachments(t) {
            let e, i;
            let a = [].concat(this.mail.attachments || []).map((t, e) => {
              let i;
              let a = /^message\//i.test(t.contentType);
              /^data:/i.test(t.path || t.href) && (t = this._processDataUrl(t));
              let n =
                  t.contentType ||
                  s.detectMimeType(t.filename || t.path || t.href || 'bin'),
                o = /^image\//i.test(n);
              return (
                (i = {
                  contentType: n,
                ...
                t.filename
                  ...
                  : !a &&
                    ...
                    0 > i.filename.indexOf('.') &&
                      (i.filename += '.' + s.detectExtension(i.contentType))),
                /^https?:\/\//i.test(t.path) &&
            ...
            t)
              ? {
                  attached: a.filter((t) => !t.cid).concat(i || []),
                  related: a.filter((t) => !!t.cid),
                }
              : { attached: a.concat(i || []), related: [] };
          }
          getAlternatives() {
            let t = [],
              e,
            ...
            return (
              ...
              this.mail.watchHtml &&
                ((a =
                  ...
                  'text/watch-html; charset=utf-8'),
              this.mail.amp &&
                ((n =
                  'object' == typeof this.mail.amp &&
                  (this.mail.amp.content ||
                    this.mail.amp.path ||
                    this.mail.amp.href ||
                    this.mail.amp.raw)
                    ? this.mail.amp
                    : { content: this.mail.amp }).contentType =
              ...
              this.mail.icalEvent &&
                ...
                (r.contentType =
                  ...
                  (r.method || 'PUBLISH').toString().trim().toUpperCase()),
                r.headers || (r.headers = {})),
              this.mail.html &&
                ((i =
              ...
              []
                ...
                .forEach((e) => {
                  let i;
                  /^data:/i.test(e.path || e.href) &&
                    (e = this._processDataUrl(e)),
                    (i = {
                      contentType:
                        e.contentType ||
                        s.detectMimeType(
                          e.filename || e.path || e.href || 'txt'
                        ),
                      contentTransferEncoding: e.contentTransferEncoding,
                    }),
                    e.filename && (i.filename = e.filename),
                    /^https?:\/\//i.test(e.path) &&
                      ((e.href = e.path), (e.path = void 0)),
                    e.raw
                      ? (i.raw = e.raw)
                      : e.path
                        ? (i.content = { path: e.path })
                        : e.href
                          ? (i.content = { href: e.href })
                          : (i.content = e.content || ''),
          ...
          _createRelated(t) {
            ...
            return (
              (e = t
                ...
                : new a('multipart/related; type="text/html"', {
                    baseBoundary: this.mail.baseBoundary,
                    textEncoding: this.mail.textEncoding,
                    boundaryPrefix: this.mail.boundaryPrefix,
                    disableUrlAccess: this.mail.disableUrlAccess,
              ...
              (!/^text\//i.test(e.contentType) || e.contentDisposition) &&
                i.setHeader(
                  ...
                  e.contentDisposition ||
                    (e.cid && /^image\//i.test(e.contentType)
                      ? 'inline'
                      : 'attachment')
                ),
              'string' != typeof e.content ||
                ['utf8', 'usascii', 'ascii'].includes(s) ||
                (e.content = Buffer.from(e.content, s)),
          ...
          _processDataUrl(t) {
            let e;
            return (
              (t.path || t.href).match(/^data:/) && (e = n(t.path || t.href)),
              e &&
                ((t.content = e.data),
                (t.contentType = t.contentType || e.contentType),
                'path' in t && (t.path = !1),
                'href' in t && (t.href = !1)),
              t
            );
        ...
        class f extends a {
          constructor(t, e, i) {
            super(),
              ...
              (this.meta = new Map()),
              (this.dkim = !!this.options.dkim && new r(this.options.dkim)),
              (this.transporter = t),
              ...
              'function' == typeof this.transporter.on &&
          ...
          sendMail(t, e = null) {
            ...
            return (
              ...
              this._processPlugins('compile', a, (t) => {
                if (t)
                  return (
                    this.logger.error(
                ...
                (a.message = new o(a.data).compile()),
                  a.setMailerHeader(),
                  a.setPriorityHeaders(),
                  a.setListHeaders(),
                  this._processPlugins('stream', a, (t) => {
                    if (t)
                      return (
                        this.logger.error(
                    ...
                    (a.data.dkim || this.dkim) &&
                      a.message.processFunc((t) => {
                        let e = a.data.dkim ? new r(a.data.dkim) : this.dkim;
                        return (
                          this.logger.debug(
                            {
                              tnx: 'DKIM',
                          ...
                          e.sign(t, a.data._dkim)
                        );
                      }),
                      this.transporter.send(a, (...t) => {
                        t[0] &&
                          this.logger.error(
          ...
          _processPlugins(t, e, i) {
            if (
              ...
              return i();
            let a = this._userPlugins[t] || [],
              s = this._defaultPlugins[t] || [];
            if (
              (a.length &&
                this.logger.debug(
                  { tnx: 'transaction', pluginCount: a.length, step: t },
            ...
            let n = 0,
              ...
              r = () => {
                let t = 'default' === o ? s : a;
                if (n >= t.length) {
                  if ('default' !== o || !a.length) return i();
                  (o = 'user'), (n = 0), (t = a);
                }
                (0, t[n++])(e, (t) => {
                  if (t) return i(t);
          ...
          setupProxy(t) {
            let e = l.parse(t);
            this.getSocket = (t, i) => {
              let a = e.protocol.replace(/:$/, '').toLowerCase();
              if (this.meta.has('proxy_handler_' + a))
                return this.meta.get('proxy_handler_' + a)(e, t, i);
              switch (a) {
                case 'http':
                case 'https':
                  p(e.href, t.port, t.host, (t, e) =>
                ...
                case 'socks4a': {
                  if (!this.meta.has('proxy_socks_module'))
                    return i(Error('Socks module not loaded'));
                  let a = (a) => {
                    let s = !!this.meta.get('proxy_socks_module').SocksClient,
                      n = s
                        ? this.meta.get('proxy_socks_module').SocksClient
                        : this.meta.get('proxy_socks_module'),
                      o = Number(e.protocol.replace(/\D/g, '')) || 5,
                      r = {
                        proxy: { ipaddress: a, port: Number(e.port), type: o },
                    ...
                    if (e.auth) {
                      ...
                      s
                        ? ((r.proxy.userId = t), (r.proxy.password = i))
                        : 4 === o
                          ? (r.userid = t)
                          : (r.authentication = { username: t, password: i });
                    }
                    n.createConnection(r, (t, e) =>
                      t ? i(t) : i(null, { connection: e.socket || e })
                    );
                  };
                  if (h.isIP(e.hostname)) return a(e.hostname);
                  return u.resolve(e.hostname, (t, e) => {
                    if (t) return i(t);
                    a(Array.isArray(e) ? e[0] : e);
                  });
                }
              }
              i(Error('Unknown proxy configuration'));
            };
          }
          _convertDataImages(t, e) {
            if (
              ...
              return e();
            t.resolveContent(t.data, 'html', (i, a) => {
              if (i) return e(i);
              let s = 0;
              (a = (a || '')
                .toString()
                .replace(
                  ...
                  (e, i, a, o) => {
                    let r = x.randomBytes(10).toString('hex') + '@localhost';
                    return (
                      ...
                      t.data.attachments.push({
                        path: a,
                        cid: r,
                        filename: 'image-' + ++s + '.' + n.detectExtension(o),
                      }),
                      i + 'cid:' + r
                    );
                  }
                  ...
                  ? 'headers' === t &&
                    Object.keys(a.headers).forEach((t) => {
                      t in this.data.headers ||
                        (this.data.headers[t] = a.headers[t]);
                    })
                  : (this.data[t] = a[t]);
              }),
              [
          ...
          resolveAll(t) {
              ...
              this.data.attachments &&
                ...
                this.data.attachments.forEach((t, i) => {
                  !t.filename &&
                    ...
                    0 > t.filename.indexOf('.') &&
                      (t.filename += '.' + n.detectExtension(t.contentType))),
                    t.contentType ||
                      (t.contentType = n.detectMimeType(
            ...
            let o = 0,
              r = () => {
                ...
                let i = e[o++];
                if (!i[0] || !i[0][i[1]]) return r();
                a.resolveContent(...i, (e, a) => {
                  if (e) return t(e);
                  let s = { content: a };
                  i[0][i[1]] &&
          ...
          normalize(t) {
            ...
            this.resolveAll((a, s) =>
              a
                ...
                : ((s.envelope = e),
                  (s.messageId = i),
                  ['html', 'text', 'watchHtml', 'amp'].forEach((t) => {
                    s[t] &&
                      s[t].content &&
                      ('string' == typeof s[t].content
                        ? (s[t] = s[t].content)
                        : Buffer.isBuffer(s[t].content) &&
                          (s[t] = s[t].content.toString()));
                  }),
                  s.icalEvent &&
                    Buffer.isBuffer(s.icalEvent.content) &&
                    ((s.icalEvent.content =
                      s.icalEvent.content.toString('base64')),
                    (s.icalEvent.encoding = 'base64')),
                  s.alternatives &&
                    s.alternatives.length &&
                    s.alternatives.forEach((t) => {
                      t &&
                        t.content &&
                  ...
                  (s.normalizedHeaders = {}),
                  Object.keys(s.headers || {}).forEach((t) => {
                    let e = [].concat(s.headers[t] || []).shift();
                    (e = (e && e.value) || e) &&
                      ([
                        'references',
                        'in-reply-to',
                      ...
                      (s.normalizedHeaders[t] = e));
                  }),
                  s.list &&
                    'object' == typeof s.list &&
                    this._getListHeaders(s.list).forEach((t) => {
                      s.normalizedHeaders[t.key] = t.value
                        .map((t) => (t && t.value) || t)
                        .join(', ');
                    }),
                  s.references &&
                    (s.normalizedHeaders.references =
                      this.message._encodeHeaderValue(
                        'references',
                        s.references
                      )),
                  s.inReplyTo &&
                    (s.normalizedHeaders['in-reply-to'] =
                      this.message._encodeHeaderValue(
                        'in-reply-to',
                        s.inReplyTo
                      )),
            ...
            return Object.keys(t).map((e) => ({
              ...
              value: [].concat(t[e] || []).map((t) => ({
                ...
                value: []
                  ...
                  .map((t) => {
                    if (
                      ('string' == typeof t && (t = { url: t }), t && t.url)
                    ) {
                      ...
                      let i = t.comment || '';
                      return (
                        n.isPlainText(i) || (i = n.encodeWord(i)),
      ...
      3740: (t, e, i) => {
        ...
        t.exports = {
          ...
          hasLongerLines: (t, e) =>
            t.length > 131072 || RegExp('^.{' + (e + 1) + ',}', 'm').test(t),
          encodeWord(t, e, i) {
            let n;
            e = (e || 'Q').toString().toUpperCase().trim().charAt(0);
            let o = 'UTF-8';
            if (
              ((i = i || 0) && i > 7 + o.length && (i -= 7 + o.length),
              'Q' === e
                ? (n = s.encode(t).replace(/[^a-z0-9!*+\-/=]/gi, (t) => {
                    let e = t.charCodeAt(0).toString(16).toUpperCase();
                    return ' ' === t
                      ? '_'
                      : '=' + (1 === e.length ? '0' + e : e);
                  }))
                : 'B' === e &&
                  ((n = 'string' == typeof t ? t : a.encode(t)),
                  (i = i ? Math.max(3, ((i - (i % 4)) / 4) * 3) : 0)),
              i && ('B' !== e ? n : a.encode(t)).length > i)
            ) {
              if ('Q' === e)
                n = this.splitMimeEncodedString(n, i).join(
                  '?= =?' + o + '?' + e + '?'
                );
              else {
                let t = [],
                ...
                for (let e = 0, o = n.length; e < o; e++) {
                  ...
                  /[\ud83c\ud83d\ud83e]/.test(r) &&
                    e < o - 1 &&
                    (r += n.charAt(++e)),
                    Buffer.byteLength(s + r) <= i || 0 === e
                      ? (s += r)
                      : (t.push(a.encode(s)), (s = r));
                }
                s && t.push(a.encode(s)),
                  (n =
                    t.length > 1
          ...
          encodeWords(t, e, i, a) {
            ...
            let s = t.match(/(?:^|\s)([^\s]*["\u0080-\uFFFF])/);
            if (!s) return t;
            if (a) return this.encodeWord(t, e, i);
            let n = t.match(/(["\u0080-\uFFFF][^\s]*)[^"\u0080-\uFFFF]*$/);
            if (!n) return t;
            let o = s.index + (s[0].match(/[^\s]/) || { index: 0 }).index,
              r = n.index + (n[1] || '').length;
            return (
              (o ? t.substr(0, o) : '') +
              this.encodeWord(t.substring(o, r), e || 'Q', i) +
              (r < t.length ? t.substr(r) : '')
            );
          },
          buildHeaderValue(t) {
            let e = [];
            return (
              Object.keys(t.params || {}).forEach((i) => {
                let a = t.params[i];
                !this.isPlainText(a, !0) || a.length >= 75
                  ? this.buildHeaderParam(i, a, 50).forEach((t) => {
                      /[\s"\\;:/=(),<>@[\]?]|^[-']|'$/.test(t.value) &&
                      '*' !== t.key.substr(-1)
          ...
          buildHeaderParam(t, e, i) {
            let a,
              ...
              p,
              c = [],
              l = 'string' == typeof e ? e : (e || '').toString(),
              d = 0;
            if (((i = i || 50), this.isPlainText(e, !0))) {
              if (l.length <= i) return [{ key: t, value: l }];
              (l = l.replace(
                RegExp('.{' + i + '}', 'g'),
                (t) => (c.push({ line: t }), '')
              )) && c.push({ line: l });
              ...
              if (/[\uD800-\uDBFF]/.test(l)) {
                for (r = 0, a = [], p = l.length; r < p; r++)
                  (n = (s = l.charAt(r)).charCodeAt(0)) >= 55296 &&
                  n <= 56319 &&
                  r < p - 1
                    ? ((s += l.charAt(r + 1)), a.push(s), r++)
                    : a.push(s);
                l = a;
              }
              o = "utf-8''";
              let t = !0;
              for (r = 0, d = 0, p = l.length; r < p; r++) {
                if (((s = l[r]), t)) s = this.safeEncodeURIComponent(s);
                else if (
                  (s = ' ' === s ? s : this.safeEncodeURIComponent(s)) !== l[r]
                ) {
                  if ((this.safeEncodeURIComponent(o) + s).length >= i)
                    c.push({ line: o, encoded: t }), (o = ''), (d = r - 1);
                  else {
                    (t = !0), (r = d), (o = '');
                    continue;
                  }
                ...
                (o + s).length >= i
                  ? (c.push({ line: o, encoded: t }),
                    (o = s =
                      ' ' === l[r] ? ' ' : this.safeEncodeURIComponent(l[r])),
                    s === l[r] ? ((t = !1), (d = r - 1)) : (t = !0))
                  : (o += s);
              }
          ...
          parseHeaderValue(t) {
            ...
            for (let p = 0, c = t.length; p < c; p++)
              if (((e = t.charAt(p)), 'key' === n)) {
                if ('=' === e) {
                  (a = s.trim().toLowerCase()), (n = 'value'), (s = '');
                  continue;
                }
                s += e;
              } else {
            ...
            return (
              'value' === n
                ? !1 === a
                  ? (i.value = s.trim())
                  : (i.params[a] = s.trim())
                : s.trim() && (i.params[s.trim().toLowerCase()] = ''),
              Object.keys(i.params).forEach((t) => {
                let e, a, s, n;
                (s = t.match(/(\*(\d+)|\*(\d+)\*|\*)$/)) &&
                  ((e = t.substr(0, s.index)),
                  (a = Number(s[2] || s[3]) || 0),
                  ...
                  0 === a &&
                    '*' === s[0].substr(-1) &&
                    (s = n.match(/^([^']*)'[^']*'(.*)$/)) &&
                    ((i.params[e].charset = s[1] || 'iso-8859-1'), (n = s[2])),
                  (i.params[e].values[a] = n),
                  delete i.params[t]);
              }),
              Object.keys(i.params).forEach((t) => {
                let e;
          ...
          detectExtension: (t) => n.detectExtension(t),
          detectMimeType: (t) => n.detectMimeType(t),
          foldLines(t, e, i) {
            (t = (t || '').toString()), (e = e || 76);
            let a = 0,
              s = t.length,
            ...
            for (; a < s; ) {
              ...
              (r = o.match(/(\s+)[^\s]*$/)) &&
              r[0].length - (i ? (r[1] || '').length : 0) < o.length
                ? (o = o.substr(
                    0,
                    o.length - (r[0].length - (i ? (r[1] || '').length : 0))
                  ))
                : (r = t.substr(a + o.length).match(/^[^\s]+(\s*)/)) &&
                  (o += r[0].substr(
                    0,
                    r[0].length - (i ? 0 : (r[1] || '').length)
                  )),
                (n += o),
                (a += o.length) < s && (n += '\r\n');
            }
          ...
          splitMimeEncodedString: (t, e) => {
            ...
            for (e = Math.max(e || 0, 12); t.length; ) {
              for (
                (a = (i = t.substr(0, e)).match(/[=][0-9A-F]?$/i)) &&
                ...
                (n = !0),
                  (a = t.substr(i.length).match(/^[=]([0-9A-F]{2})/i)) &&
                    (s = parseInt(a[1], 16)) < 194 &&
                    s > 127 &&
                    ((i = i.substr(0, i.length - 3)), (n = !1));
          ...
          encodeURICharComponent: (t) => {
            let e = '',
              i = t.charCodeAt(0).toString(16).toUpperCase();
            if ((i.length % 2 && (i = '0' + i), i.length > 2))
              for (let t = 0, a = i.length / 2; t < a; t++)
                e += '%' + i.substr(t, 2);
            else e += '%' + i;
            return e;
          },
          safeEncodeURIComponent(t) {
            ...
            return t.replace(
              /[\x00-\x1F *'()<>@,;:\\"[\]?=\u007F-\uFFFF]/g,
              (t) => this.encodeURICharComponent(t)
            );
          },
        };
      },
          ...
          detectMimeType(t) {
            ...
            let e = a.parse(t),
              i = (e.ext.substr(1) || e.name || '')
                ...
                .toLowerCase(),
              n = s;
            return (o.has(i) && (n = o.get(i)), Array.isArray(n)) ? n[0] : n;
          },
          detectExtension(t) {
            if (!t) return 'bin';
            let e = (t || '').toLowerCase().trim().split('/'),
              i = e.shift().trim(),
              a = e.join('/').trim();
            if (n.has(i + '/' + a)) {
              let t = n.get(i + '/' + a);
        ...
        class f {
          constructor(t, e) {
            (this.nodeCounter = 0),
              (e = e || {}),
              (this.baseBoundary =
                e.baseBoundary || a.randomBytes(8).toString('hex')),
              ...
              e.filename &&
                ...
                t || (t = p.detectMimeType(this.filename.split('.').pop()))),
          ...
          setHeader(t, e) {
            ...
            a = { key: (t = this._normalizeHeaderKey(t)), value: e };
            for (let e = 0, s = this._headers.length; e < s; e++)
              this._headers[e].key === t &&
                (i
                  ? (this._headers.splice(e, 1), e--, s--)
                  : ((this._headers[e] = a), (i = !0)));
            return i || this._headers.push(a), this;
          }
          addHeader(t, e) {
            return (
              !e && t && 'object' == typeof t
            ...
            return (
              ...
              'function' == typeof this.content.pipe
                ...
                : 'string' == typeof this.content &&
                  ((this._isPlainText = p.isPlainText(this.content)),
                  this._isPlainText &&
                    p.hasLongerLines(this.content, 76) &&
          ...
          build(t) {
            ...
            return (
              i.on('readable', () => {
                let t;
                for (; null !== (t = i.read()); ) a.push(t), (s += t.length);
              }),
              i.once('error', (e) => {
                if (!n) return (n = !0), t(e);
              }),
              i.once('end', (e) => {
                if (!n)
                  return (
                    (n = !0),
                    e && e.length && (a.push(e), (s += e.length)),
                    t(null, Buffer.concat(a, s))
                  );
              }),
              e
            );
          ...
          buildHeaders() {
            ...
            if (
              ...
              for (let t = this._headers.length - 2; t >= 0; t--) {
                let e = this._headers[t];
                'Content-Type' === e.key &&
                  (this._headers.splice(t, 1), this._headers.push(e));
              }
            }
            return (
              this._headers.forEach((t) => {
                ...
                if (
                  ...
                  (n = (n.value || '').toString()).trim())
                ) {
                  if (o.prepared) {
                    o.foldLines
                      ? e.push(p.foldLines(s + ': ' + n))
                      : e.push(s + ': ' + n);
                    return;
                  }
                  switch (t.key) {
                    case 'Content-Disposition':
                      (i = p.parseHeaderValue(n)),
                        this.filename && (i.params.filename = this.filename),
                        (n = p.buildHeaderValue(i));
                      break;
                    case 'Content-Type':
                      (i = p.parseHeaderValue(n)),
                        ...
                        (n = p.buildHeaderValue(i)),
                        this.filename &&
                          (((a = this._encodeWords(this.filename)) !==
                            this.filename ||
                            /[\s'"\\;:/=(),<>@[\]?]|^-/.test(a)) &&
                            (a = '"' + a + '"'),
                          (n += '; name=' + a));
                  ...
                  if (
                    ((n = this._encodeHeaderValue(s, n)) || '')
                      .toString()
                      .trim()
                  ) {
                    if ('function' == typeof this.normalizeHeaderKey) {
                      let t = this.normalizeHeaderKey(s, n);
                      t && 'string' == typeof t && t.length && (s = t);
                    }
                    e.push(p.foldLines(s + ': ' + n, 76));
                  }
                }
              }),
              e.join('\r\n')
          ...
          createReadStream(t) {
            ...
            for (let t = 0, i = this._processFuncs.length; t < i; t++)
              a = (e = this._processFuncs[t])(a);
            if (this.newline) {
              let t = ['win', 'windows', 'dos', '\r\n'].includes(
                  this.newline.toString().toLowerCase()
                )
                  ? new u()
                  : new x(),
                e = a.pipe(t);
              return a.on('error', (t) => e.emit('error', t)), e;
            }
            return a;
          }
          transform(t) {
          ...
          stream(t, e, i) {
            ...
            this._raw
              ...
              : (t.write(this.buildHeaders() + '\r\n\r\n'),
                setImmediate(() => {
                  if (!this.content) return setImmediate(p);
                  {
                    if (
                      '[object Error]' ===
                    ...
                    'function' == typeof this.content.pipe &&
                      ...
                      (this._contentErrorHandler = (t) => r(t)),
                      this.content.once('error', this._contentErrorHandler));
                    let i = () => {
                      ['quoted-printable', 'base64'].includes(n)
                        ? ((a = new ('base64' === n ? l : c).Encoder(e)).pipe(
                            t,
                            { end: !1 }
                          ),
                          a.once('end', p),
                          a.once('error', (t) => r(t)),
                          (s = this._getStream(this.content)).pipe(a))
                        : ((s = this._getStream(this.content)).pipe(t, {
                            end: !1,
                          }),
                          s.once('end', p)),
                        s.once('error', (t) => r(t));
                    ...
                    if (this.content._resolve) {
                      let t = [],
                        e = 0,
                        a = !1,
                        s = this._getStream(this.content);
                      s.on('error', (t) => {
                        a || ((a = !0), r(t));
                      }),
                        s.on('readable', () => {
                  ...
                  ? this.disableFileAccess
                    ? ((e = new o()),
                      setImmediate(() =>
                        e.emit(
                          'error',
                          Error('File access rejected for ' + t.path)
                        )
                      ),
                      e)
                    : s.createReadStream(t.path)
                    ...
                    ? this.disableUrlAccess
                      ? ((e = new o()),
                        setImmediate(() =>
                          e.emit(
                            'error',
                            Error('Url access rejected for ' + t.href)
                          )
                        ),
                        e)
                      : m(t.href, { headers: t.httpHeaders })
                    : ((e = new o()),
                      setImmediate(() => {
                        try {
                          e.end(t || '');
          ...
          _handleContentType(t) {
            (this.contentType = t.value.trim().toLowerCase()),
              (this.multipart =
                !!/^multipart\//i.test(this.contentType) &&
            ...
            switch ((t = this._normalizeHeaderKey(t))) {
              ...
              case 'Date':
                if ('[object Date]' === Object.prototype.toString.call(e))
                  return e.toUTCString().replace(/GMT/, '+0000');
                return (
                  (e = (e || '').toString().replace(/\r?\n|\r/g, ' ')),
                  this._encodeWords(e)
                );
                ...
                if (t.address)
                  (t.address = this._normalizeAddress(t.address)),
                    t.name
                      ? t.name &&
                        i.push(
                          `${this._encodeAddressName(t.name)} <${t.address}>`
                        )
                      : i.push(
                          t.address.indexOf(' ') >= 0
                            ? `<${t.address}>`
                  ...
                  let a = (
                    t.group.length ? this._convertAddresses(t.group, e) : ''
                  ).trim();
                  i.push(`${this._encodeAddressName(t.name)}:${a};`);
                }
              }),
              i.join(', ')
            );
          ...
          _encodeAddressName(t) {
            return /^[\w ]*$/.test(t)
              ...
              : /^[\x20-\x7e]*$/.test(t)
                ? '"' + t.replace(/([\\"])/g, '\\$1') + '"'
                : p.encodeWord(t, this._getTextEncoding(t), 52);
          }
          _encodeWords(t) {
            return p.encodeWords(t, this._getTextEncoding(t), 52, !0);
          }
          _getTextEncoding(t) {
            t = (t || '').toString();
            let e = this.textEncoding;
            return (
              e ||
                (e =
                  (t.match(/[\x00-\x08\x0B\x0C\x0E-\x1F\u0080-\uFFFF]/g) || [])
                    .length < (t.match(/[a-z]/gi) || []).length
                    ? 'Q'
                    : 'B'),
              e
            );
          ...
          _generateMessageId() {
            return (
              '<' +
              [2, 2, 2, 6].reduce(
                (t, e) => t + '-' + a.randomBytes(e).toString('hex'),
                a.randomBytes(4).toString('hex')
              ) +
              '@' +
      ...
      3137: (t, e, i) => {
        ...
        class s extends a {
          ...
          _transform(t, e, i) {
            ...
            let s = 0;
            for (let e = 0, i = t.length; e < i; e++)
              13 === t[e] && ((a = t.slice(s, e)), (s = e + 1), this.push(a));
            s && s < t.length
              ? ((a = t.slice(s)), this.push(a))
              : s || this.push(t),
              i();
          }
        }
      ...
      8721: (t, e, i) => {
        ...
        let a = i(5570),
          ...
          u = (process.env.ETHEREAL_WEB || 'https://ethereal.email').replace(
            /\/+$/,
            ''
          ),
          x = (process.env.ETHEREAL_API_KEY || '').replace(/\s*/g, '') || null,
        ...
        (t.exports.createTransport = function (t, e) {
          ...
          return (
            (('object' == typeof t && 'function' != typeof t.send) ||
              ...
              (t = (d = (i = 'string' == typeof t ? t : t.url)
                ? s.parseConnectionUrl(i)
                : t).pool
                ? new n(d)
                : d.sendmail
                  ? new r(d)
          ...
          (t.exports.createTestAccount = function (t, e) {
            ...
            let a = [],
              n = 0,
              o = {},
              r = { requestor: m.name, version: m.version };
            x && (o.Authorization = 'Bearer ' + x);
            let p = d(t + '/user', {
            ...
            return (
              p.on('readable', () => {
                let t;
                for (; null !== (t = p.read()); ) a.push(t), (n += t.length);
              }),
              p.once('error', (t) => e(t)),
              p.once('end', () => {
                let t,
                ...
                return i
                  ...
                  : 'success' !== t.status || t.error
                    ? e(Error(t.error || 'Request failed'))
                    : void (delete t.status, e(null, (g = t)));
              }),
              i
            );
          }),
          (t.exports.getTestMessageUrl = function (t) {
            ...
            return (
              t.response.replace(/\[([^\]]+)\]$/, (t, i) => {
                i.replace(/\b([A-Z0-9]+)=([^\s]+)/g, (t, i, a) => {
                  e.set(i, a);
                });
              }),
              !!(e.has('STATUS') && e.has('MSGID')) &&
                (g.web || u) + '/message/' + e.get('MSGID')
            );
          });
      },
      4897: (t) => {
        ...
        function c(t) {
          ...
          for (; i < a; ) {
            ...
            if (s >= 55296 && s <= 56319 && i < a) {
              let a = t.charCodeAt(i++);
              (64512 & a) == 56320
                ? e.push(((1023 & s) << 10) + (1023 & a) + 65536)
                : (e.push(s), i--);
            } else e.push(s);
          }
          return e;
        ...
        let l = function (t, e) {
          ...
          d = function (t, e, i) {
            let a = 0;
            for (t = i ? n(t / 700) : t >> 1, t += n(t / e); t > 455; a += 36)
              t = n(t / 35);
            return n(a + (36 * t) / (t + 38));
          },
          m = function (t) {
            let e = [],
              i = t.length,
            ...
            p < 0 && (p = 0);
            for (let i = 0; i < p; ++i)
              t.charCodeAt(i) >= 128 && r('not-basic'), e.push(t.charCodeAt(i));
            for (let l = p > 0 ? p + 1 : 0; l < i; ) {
              let p = a;
              for (let e = 1, s = 36; ; s += 36) {
                var c;
                l >= i && r('invalid-input');
                let p =
                  (c = t.charCodeAt(l++)) >= 48 && c < 58
                    ? 26 + (c - 48)
                    : c >= 65 && c < 91
                      ? c - 65
                      : c >= 97 && c < 123
                        ? c - 97
                        : 36;
                p >= 36 && r('invalid-input'),
                  p > n((0x7fffffff - a) / e) && r('overflow'),
                  (a += p * e);
                let d = s <= o ? 1 : s >= o + 26 ? 26 : s - o;
                if (p < d) break;
                let m = 36 - d;
                e > n(0x7fffffff / m) && r('overflow'), (e *= m);
              }
              let m = e.length + 1;
              (o = d(a - p, m, 0 == p)),
                n(a / m) > 0x7fffffff - s && r('overflow'),
                (s += n(a / m)),
                (a %= m),
                e.splice(a++, 0, s);
            }
          ...
          h = function (t) {
            let e = [],
              ...
              s = 0,
              p = 72;
            for (let i of t) i < 128 && e.push(o(i));
            let m = e.length,
              h = m;
            for (m && e.push('-'); h < i; ) {
              let i = 0x7fffffff;
              for (let e of t) e >= a && e < i && (i = e);
              let c = h + 1;
              for (let u of (i - a > n((0x7fffffff - s) / c) && r('overflow'),
              (s += (i - a) * c),
              (a = i),
              t))
                if ((u < a && ++s > 0x7fffffff && r('overflow'), u === a)) {
                  let t = s;
                  for (let i = 36; ; i += 36) {
                    let a = i <= p ? 1 : i >= p + 26 ? 26 : i - p;
                    if (t < a) break;
                    let s = t - a,
                      r = 36 - a;
                    e.push(o(l(a + (s % r), 0))), (t = n(s / r));
                  }
                  e.push(o(l(t, 0))), (p = d(s, c, h === m)), (s = 0), ++h;
                }
              ++s, ++a;
            }
            return e.join('');
        ...
        t.exports = {
          version: '2.3.1',
          ucs2: { decode: c, encode: (t) => String.fromCodePoint(...t) },
          decode: m,
          encode: h,
          toASCII: function (t) {
          ...
          toUnicode: function (t) {
            return p(t, function (t) {
              return e.test(t) ? m(t.slice(4).toLowerCase()) : t;
            });
          },
        };
      },
            ...
            if (
              (function (t, e) {
                for (let i = e.length - 1; i >= 0; i--)
                  if (
                    e[i].length &&
                    ((1 === e[i].length && t === e[i][0]) ||
                      (2 === e[i].length && t >= e[i][0] && t <= e[i][1]))
                  )
                    return !0;
                return !1;
              })((e = t[s]), i) &&
              !(
                (32 === e || 9 === e) &&
                (s === n - 1 || 10 === t[s + 1] || 13 === t[s + 1])
              )
            ) {
              a += String.fromCharCode(e);
              continue;
            }
            a += '=' + (e < 16 ? '0' : '') + e.toString(16).toUpperCase();
          }
          return a;
        }
        function n(t, e) {
          ...
          let n = 0,
            ...
            p = '';
          for (; n < o; ) {
            if ((i = (s = t.substr(n, e)).match(/\r\n/))) {
              (p += s = s.substr(0, i.index + i[0].length)), (n += s.length);
              continue;
            }
            if ('\n' === s.substr(-1)) {
              (p += s), (n += s.length);
            ...
            if ((i = s.substr(-r).match(/\n.*?$/))) {
              (p += s = s.substr(0, s.length - (i[0].length - 1))),
                (n += s.length);
              continue;
            }
            if (
              ...
              s = s.substr(0, s.length - (i[0].length - 1));
            else if (s.match(/[=][\da-f]{0,2}$/i))
              for (
                (i = s.match(/[=][\da-f]{0,1}$/i)) &&
                (s = s.substr(0, s.length - i[0].length));
                s.length > 3 &&
                s.length < o - n &&
                !s.match(/^(?:=[\da-f]{2}){1,4}$/i) &&
                (i = s.match(/[=][\da-f]{2}$/gi)) &&
                !((a = parseInt(i[0].substr(1, 2), 16)) < 128) &&
                ((s = s.substr(0, s.length - 3)), !(a >= 192));

              );
            n + s.length < o && '\n' !== s.substr(-1)
              ? (s.length === e && s.match(/[=][\da-f]{2}$/i)
                  ? (s = s.substr(0, s.length - 3))
                  : s.length === e && (s = s.substr(0, s.length - 1)),
                (n += s.length),
                (s += '=\r\n'))
              : (n += s.length),
              (p += s);
            ...
            (this.inputBytes += t.length),
              this.options.lineLength
                ? (a = (a = n(
                  ...
                  )) && ((this.outputBytes += a.length), this.push(a))
                : ((a = s(t)),
                  (this.outputBytes += a.length),
                  this.push(a, 'ascii')),
              i();
        ...
        class o {
          constructor(t) {
            (t = t || {}),
              ...
              (this.args = !1),
              (this.winbreak = !1),
              (this.logger = n.getLogger(this.options, {
          ...
          send(t, e) {
            ...
            if (
              ...
              return e(Error('Can not send mail. Invalid envelope addresses.'));
            i = this.args
              ? ['-i'].concat(this.args).concat(n.to)
              : ['-i'].concat(n.from ? ['-f', n.from] : []).concat(n.to);
            let r = (i) => {
              if (!s && ((s = !0), 'function' == typeof e))
                return i
                  ? e(i)
                  : e(null, {
            ...
            try {
              a = this._spawn(this.path, i);
            } catch (t) {
              return (
                this.logger.error(
                  { err: t, tnx: 'spawn', messageId: o },
            ...
            if (!a) return r(Error('sendmail was not found'));
            {
              a.on('error', (t) => {
                this.logger.error(
                  { err: t, tnx: 'spawn', messageId: o },
                ...
                a.once('exit', (t) => {
                  ...
                  (e =
                    127 === t
                      ...
                      : Error('Sendmail exited with code ' + t)),
                    this.logger.error(
                      { err: e, tnx: 'stdin', messageId: o },
      ...
      511: (t, e, i) => {
        ...
        class r extends a {
          ...
          _send(t, e) {
            ...
            let a = t.data.envelope || t.message.getEnvelope(),
              s = t.message.messageId(),
              n = [].concat(a.to || []);
            n.length > 3 && n.push('...and ' + n.splice(2).length + ' more'),
              this.logger.info(
                { tnx: 'send', messageId: s },
                'Sending message %s to <%s>',
                s,
                n.join(', ')
              );
            let r = (e) => {
              ...
              a.on('readable', () => {
                let t;
                for (; null !== (t = a.read()); ) s.push(t), (n += t.length);
              }),
                i.once('error', (t) => a.emit('error', t)),
                a.once('error', (t) => {
                  e(t);
                }),
                a.once('end', () => e(null, Buffer.concat(s, n)));
            };
            setImmediate(() =>
              r((n, o) => {
                var r;
                ...
                let c = (this.ses.aws ? this.ses.ses : this.ses) || {},
                  l = this.ses.aws || {};
                (r = (t, n) => {
                  (t || !n) && (n = 'us-east-1'),
                    ('function' == typeof c.send && l.SendRawEmailCommand
                      ? c.send(new l.SendRawEmailCommand(p))
                      : c.sendRawEmail(p).promise()
                    )
                      .then((t) => {
                        'us-east-1' === n && (n = 'email'),
                          (i.pending = !1),
                          e(null, {
                            envelope: { from: a.from, to: a.to },
                            messageId:
                              '<' +
                              t.MessageId +
                              (/@/.test(t.MessageId)
                  ...
                  c.config && 'function' == typeof c.config.region
                    ? c.config
                        .region()
                        .then((t) => r(null, t))
                        .catch((t) => r(t))
                    : r(null, (c.config && c.config.region) || 'us-east-1');
              })
            );
          }
          verify(t) {
            let e;
            let i = (this.ses.aws ? this.ses.ses : this.ses) || {},
              a = this.ses.aws || {},
              s = {
                RawMessage: {
            ...
            t ||
              (e = new Promise((e, i) => {
                t = n.callbackPromise(e, i);
              }));
            let o = (e) =>
              e && 'InvalidParameterValue' !== (e.code || e.Code)
                ? t(e)
                : t(null, !0);
            return (
              'function' == typeof i.send && a.SendRawEmailCommand
                ? ((s.RawMessage.Data = Buffer.from(s.RawMessage.Data)),
                  i.send(new a.SendRawEmailCommand(s), o))
                : i.sendRawEmail(s, o),
              e
            );
          }
      ...
      9919: (t, e, i) => {
        ...
        t.exports.networkInterfaces = a;
        let d = (e, i) => {
            let a = t.exports.networkInterfaces;
            return (
              !a ||
              Object.keys(a)
                .map((t) => a[t])
                .reduce((t, e) => t.concat(e), [])
                .filter((t) => !t.internal || i)
                .filter((t) => t.family === 'IPv' + e || t.family === e)
                .length > 0
            );
          },
          m = (t, e, i, a) => {
            if (!d(t, (i = i || {}).allowInternalNetworkInterfaces))
              return a(null, []);
            (p.Resolver ? new p.Resolver(i) : p)['resolve' + t](e, (t, e) => {
              if (t) {
                switch (t.code) {
                  case p.NODATA:
                  case p.NOTFOUND:
              ...
              return a(null, Array.isArray(e) ? e : [].concat(e || []));
            });
          },
          h = (t.exports.dnsCache = new Map()),
          u = (t, e) =>
            t
              ? Object.assign(
                  {
                    ...
                    host:
                      t.addresses && t.addresses.length
                        ? 1 === t.addresses.length
                          ? t.addresses[0]
                          : t.addresses[
                              Math.floor(Math.random() * t.addresses.length)
                            ]
                        : null,
                  },
                  e || {}
        ...
        function x(t, e) {
          ...
          t.on('error', (t) => {
            ...
            t.on('readable', () => {
              let e;
              for (; null !== (e = t.read()); ) a.push(e), (s += e.length);
            }),
            t.on('end', () => {
              let t;
              if (!i) {
        ...
        (t.exports.resolveHostname = (t, e) => {
          ...
          return (!(t = t || {}).host &&
            t.servername &&
            (t.host = t.servername),
          !t.host || c.isIP(t.host))
            ? e(
                null,
                u(
                  { addresses: [t.host], servername: t.servername || !1 },
                  { cached: !1 }
                )
              )
            : h.has(t.host) &&
                (!(i = h.get(t.host)).expires || i.expires >= Date.now())
              ? e(null, u(i.value, { cached: !0 }))
              : void m(4, t.host, t, (a, s) => {
                  if (a)
                    return i
                      ? e(null, u(i.value, { cached: !0, error: a }))
                      : e(a);
                  if (s && s.length) {
                    let i = {
                      addresses: s,
                  ...
                  m(6, t.host, t, (a, s) => {
                    ...
                    try {
                      p.lookup(t.host, { all: !0 }, (a, s) => {
                        ...
                        if (
                          (s &&
                            ...
                            !n &&
                            console.warn(
                              `Failed to resolve IPv${s[0].family} addresses with current network`
                            ),
                          !n && i)
                        )
                          return e(null, u(i.value, { cached: !0 }));
                        let o = {
                          addresses: n ? [n] : [t.host],
                          servername: t.servername || t.host,
                        };
                        return (
                          h.set(t.host, {
                      ...
                      if (i)
                        return e(null, u(i.value, { cached: !0, error: t }));
                      return e(t);
                    }
                  });
                });
              ...
              [s.parse(t, !0)].forEach((t) => {
                ...
                !isNaN(t.port) && Number(t.port) && (e.port = Number(t.port)),
                  ...
                  Object.keys(t.query || {}).forEach((i) => {
                    ...
                    if (0 === i.indexOf('tls.'))
                      (s = i.substr(4)), e.tls || (e.tls = {}), (a = e.tls);
          ...
          (t.exports._logFunc = (t, e, i, a, s, ...n) => {
            let o = {};
          ...
          (t.exports.getLogger = (e, i) => {
            ...
            return (
              !0 === e.logger &&
                (o = (function (t) {
                  ...
                  t.forEach((t) => {
                    ...
                    t.forEach((t) => {
                      let a = t.toUpperCase();
                      a.length < e && (a += ' '.repeat(e - a.length)),
                        i.set(t, a);
                    });
                  let a = (t, e, a, ...s) => {
                      let o = '';
              ...
              s.forEach((e) => {
                a[e] = (a, s, ...n) => {
                  t.exports._logFunc(o, e, i, a, s, ...n);
                };
              }),
              a
            );
          ...
          (t.exports.parseDataURI = (t) => {
            let e;
            let i = t.indexOf(',');
            if (!i) return t;
            let a = t.substring(i + 1),
              s = t.substring(5, i).split(';'),
              n = s.length > 1 && s[s.length - 1];
            n && 0 > n.indexOf('=') && ((e = n.toLowerCase()), s.pop());
            let o = s.shift() || 'application/octet-stream',
              r = {};
            for (let t of s) {
              let e = t.indexOf('=');
              if (e >= 0) {
            ...
            switch (e) {
              ...
              default:
                try {
                  a = Buffer.from(decodeURIComponent(a));
                } catch (t) {
                  a = Buffer.from(a);
                }
                a = Buffer.from(a);
            }
            return { data: a, encoding: e, contentType: o, params: r };
          }),
          (t.exports.resolveContent = (e, i, a) => {
            let s;
            a ||
              (s = new Promise((e, i) => {
                a = t.exports.callbackPromise(e, i);
              }));
            let n = (e && e[i] && e[i].content) || e[i],
              p = (('object' == typeof e[i] && e[i].encoding) || 'utf8')
                .toString()
                .toLowerCase()
                .replace(/[-_\s]/g, '');
            if (!n) return a(null, n);
            if ('object' == typeof n) {
              if ('function' == typeof n.pipe)
                return x(n, (t, s) => {
                  if (t) return a(t);
                  e[i].content ? (e[i].content = s) : (e[i] = s), a(null, s);
                });
              if (/^https?:\/\//i.test(n.path || n.href))
                return x(r(n.path || n.href), a);
              if (/^data:/i.test(n.path || n.href)) {
                let e = t.exports.parseDataURI(n.path || n.href);
                return e && e.data ? a(null, e.data) : a(null, Buffer.from(0));
              }
              if (n.path) return x(o.createReadStream(n.path), a);
            }
            return (
              'string' != typeof e[i].content ||
                ['utf8', 'usascii', 'ascii'].includes(p) ||
                (n = Buffer.from(e[i].content, p)),
              setImmediate(() => a(null, n)),
              s
            );
          }),
        ...
        class s extends a {
          ...
          _transform(t, e, i) {
            ...
            for (
              ...
              46 === t[o]
                ? ((!o || 10 !== t[o - 1]) &&
                    (o || (this.lastByte && 10 !== this.lastByte))) ||
                  ((a = t.slice(p, o + 1)),
                  s.push(a),
                  s.push(Buffer.from('.')),
                  (n += a.length + 1),
                  (p = o + 1))
                : 10 === t[o] &&
                  ((o && 13 !== t[o - 1]) || (!o && 13 !== this.lastByte)) &&
                  (o > p
                    ? ((a = t.slice(p, o)), s.push(a), (n += a.length + 2))
                    : (n += 2),
                  s.push(Buffer.from('\r\n')),
                  (p = o + 1));
            n
              ? (p < t.length && ((a = t.slice(p)), s.push(a), (n += a.length)),
                (this.outByteCount += n),
                this.push(Buffer.concat(s, n)))
      ...
      7802: (t, e, i) => {
        ...
        t.exports = function t(e, i, o, r) {
          ...
          (p = {
            ...
            'https:' === d.protocol
              ? ((p.rejectUnauthorized = !1), (c = s.connect.bind(s)))
              : (c = a.connect.bind(a));
          let m = !1,
            h = (t) => {
              if (!m) {
            ...
            u = () => {
              let t = Error('Proxy socket timed out');
              (t.code = 'ETIMEDOUT'), h(t);
            };
          (l = c(p, () => {
            if (m) return;
            let t = { Host: o + ':' + i, Connection: 'close' };
            d.auth &&
            ...
            let e = '',
              a = (t) => {
                ...
                if (
                  !m &&
                  ((e += t.toString('binary')), (i = e.match(/\r\n\r\n/)))
                ) {
                  if (
                    (l.removeListener('data', a),
                    (s = e.substr(i.index + i[0].length)),
                    (e = e.substr(0, i.index)),
                    s && l.unshift(Buffer.from(s, 'binary')),
                    (m = !0),
                    !(i = e.match(/^HTTP\/\d+\.\d+ (\d+)/i)) ||
                      '2' !== (i[1] || '').charAt(0))
                  ) {
                    try {
                      l.destroy();
                  ...
                  return (
                    l.removeListener('error', h),
                    l.removeListener('timeout', u),
                    l.setTimeout(0),
                    r(null, l)
                  );
                }
        ...
        class m extends s {
          constructor(t) {
            super(t),
              ...
              (this._destroyed = !1),
              (this._closing = !1),
              (this._onSocketData = (t) => this._onData(t)),
          ...
          connect(t) {
            if ('function' == typeof t) {
              ...
              let e = this._isDestroyedMessage('connect');
            ...
            let e = {
              ...
              allowInternalNetworkInterfaces:
                this.allowInternalNetworkInterfaces,
              timeout: this.options.dnsTimeout || 3e4,
            };
            ...
            let i = () => {
              ...
              }, this.options.connectionTimeout || 12e4)),
                this._socket.on('error', this._onSocketError);
            };
            if (this.options.connection) {
              (this._socket = this.options.connection),
                i(),
                this.secureConnection && !this.alreadySecured
                  ? setImmediate(() =>
                      this._upgradeConnection((t) => {
                        if (t) {
                          this._onError(
                            Error('Error initiating TLS - ' + (t.message || t)),
                            'ETLS',
                            !1,
                            'CONN'
                          );
          ...
          login(t, e) {
            let i = this._isDestroyedMessage('login');
            ...
            if (this.customAuth.has(this._authMethod)) {
                ...
                o = i({
                  ...
                  sendCommand: (e, i) => {
                    ...
                    return (
                      i ||
                        (a = new Promise((t, e) => {
                          i = d.callbackPromise(t, e);
                        })),
                      this._responseActions.push((a) => {
                        t = a;
                        let s = a.match(/^(\d+)(?:\s(\d+\.\d+\.\d+))?\s/),
                          n = { command: e, response: a };
                        s
                          ? ((n.status = Number(s[1]) || 0),
                            s[2] && (n.code = s[2]),
                            (n.text = a.substr(s[0].length)))
                          : ((n.text = a), (n.status = 0)),
                          i(null, n);
                      }),
              ...
              o && 'function' == typeof o.catch && o.then(s).catch(n);
              return;
            }
            switch (this._authMethod) {
              case 'XOAUTH2':
                this._handleXOauth2Token(!1, e);
                return;
              case 'LOGIN':
          ...
          send(t, e, i) {
            if (!e)
              return i(
                this._formatError('Empty message', 'EMESSAGE', !1, 'API')
              );
            let a = this._isDestroyedMessage('send message');
            if (a) return i(this._formatError(a, 'ECONNECTION', !1, 'API'));
            ...
            'function' == typeof e.on &&
              e.on('error', (t) =>
                n(this._formatError(t, 'ESTREAM', !1, 'API'))
              );
            let o = Date.now();
            this._setEnvelope(t, (t, i) => {
              ...
              let a = Date.now(),
                s = this._createSendStream((t, e) =>
                  t
                    ? n(t)
                    : ((i.envelopeTime = a - o),
                      (i.messageTime = Date.now() - a),
                      (i.messageSize = s.outByteCount),
                      (i.response = e),
                      n(null, i))
                );
              'function' == typeof e.pipe ? e.pipe(s) : (s.write(e), s.end());
            });
          }
          reset(t) {
          ...
          _onConnect() {
            ...
            (this.stage = 'connected'),
              ...
              this._socket.setTimeout(this.options.socketTimeout || 6e5),
              ...
              }, this.options.greetingTimeout || 3e4)),
          ...
          _onData(t) {
            ...
            let i = (t || '').toString('binary'),
              a = (this._remainder + i).split(/\r?\n/);
            this._remainder = a.pop();
          ...
          _onError(t, e, i, a) {
            clearTimeout(this._connectionTimeout),
              clearTimeout(this._greetingTimeout),
              this._destroyed ||
                ((t = this._formatError(t, e, i, a)),
                this.logger.error(i, t.message),
                this.emit('error', t),
                this.close());
          }
          _formatError(t, e, i, a) {
            let s;
            (s = /Error\]$/i.test(Object.prototype.toString.call(t))
              ? t
              : Error(t)),
              e && 'Error' !== e && (s.code = e),
              i && ((s.response = i), (s.message += ': ' + i));
            let n =
              ('string' == typeof i && Number((i.match(/^\d+/) || [])[0])) ||
              !1;
            return n && (s.responseCode = n), a && (s.command = a), s;
          }
          _onClose() {
            let t = !1;
            return (this._remainder &&
              ...
              (this.lastServerResponse = t = this._remainder.trim())),
          ...
          _onTimeout() {
            return this._onError(Error('Timeout'), 'ETIMEDOUT', !1, 'CONN');
          }
          _destroy() {
            ...
            try {
              this._socket = o.connect(
                ...
                () => (
                  ...
                  (this.upgrading = !1),
                  this._socket.on('data', this._onSocketData),
                  e.removeListener('close', this._onSocketClose),
                  e.removeListener('end', this._onSocketEnd),
                  t(null, !0)
                )
              );
            } catch (e) {
          ...
          _processResponse() {
            ...
            e.call(this, t), setImmediate(() => this._processResponse());
          }
          _sendCommand(t, e) {
            if (!this._destroyed) {
          ...
          _setEnvelope(t, e) {
            ...
            for (let t = 0, i = this._envelope.to.length; t < i; t++) {
              ...
              /[\x80-\uFFFF]/.test(this._envelope.to[t]) && (a = !0);
            }
            if (
            ...
            this._responseActions.push((t) => {
              ...
              this._envelope.dsn &&
                ...
                (this._envelope.dsn.ret &&
                  i.push('RET=' + d.encodeXText(this._envelope.dsn.ret)),
                this._envelope.dsn.envid &&
                  i.push('ENVID=' + d.encodeXText(this._envelope.dsn.envid))),
              this._sendCommand(
                'MAIL FROM:<' +
                  this._envelope.from +
                  '>' +
          ...
          _setDsnEnvelope(t) {
            ...
            if (e && !['FULL', 'HDRS'].includes(e))
              throw Error('ret: ' + JSON.stringify(e));
            ...
            if (a) {
              ...
              if (
                (a = a.map((t) => t.trim().toUpperCase())).filter(
                  (e) => !t.includes(e)
                ).length ||
                (a.length > 1 && a.includes('NEVER'))
              )
                throw Error('notify: ' + JSON.stringify(a.join(',')));
              a = a.join(',');
            }
            let s = (t.recipient || t.orcpt || '').toString() || null;
            return (
              s && 0 > s.indexOf(';') && (s = 'rfc822;' + s),
              { ret: e, envid: i, notify: a, orcpt: s }
            );
          }
          _getDsnRcptToArgs() {
            let t = [];
            return (
              this._envelope.dsn &&
                ...
                (this._envelope.dsn.notify &&
                  t.push('NOTIFY=' + d.encodeXText(this._envelope.dsn.notify)),
                this._envelope.dsn.orcpt &&
                  t.push('ORCPT=' + d.encodeXText(this._envelope.dsn.orcpt))),
              t.length ? ' ' + t.join(' ') : ''
            );
          }
          _createSendStream(t) {
            ...
            return (
              this.options.lmtp
                ? this._envelope.accepted.forEach((e, i) => {
                    let a = i === this._envelope.accepted.length - 1;
                    this._responseActions.push((i) => {
                      this._actionLMTPStream(e, a, i, t);
                    });
                  })
                : this._responseActions.push((e) => {
                    this._actionSMTPStream(e, t);
                  }),
              i.pipe(this._socket, { end: !1 }),
              this.options.debug &&
                ((e = new l()).on('readable', () => {
                  let t;
                  for (; (t = e.read()); )
          ...
          _actionGreeting(t) {
            if (
              (clearTimeout(this._greetingTimeout), '220' !== t.substr(0, 3))
            ) {
              this._onError(
                Error('Invalid greeting. response=' + t),
                'EPROTOCOL',
                t,
                'CONN'
              );
          ...
          _actionEHLO(t) {
            ...
            if ('421' === t.substr(0, 3)) {
              this._onError(
                Error('Server terminates connection. response=' + t),
                'ECONNECTION',
                t,
                'EHLO'
              );
            ...
            /[ -]SMTPUTF8\b/im.test(t) &&
              ...
              /[ -]AUTH\b/i.test(t) && (this.allowsAuth = !0),
              /[ -]AUTH(?:(\s+|=)[^\n]*\s+|\s+|=)PLAIN/i.test(t) &&
            ...
            if ('2' !== t.charAt(0))
              return this.options.opportunisticTLS
                ? (this.logger.info(
                  ...
                  this.emit('connect'))
                : void this._onError(
                    Error('Error upgrading connection with STARTTLS'),
                    'ETLS',
                    t,
                    'STARTTLS'
                  );
          ...
          _actionAUTH_CRAM_MD5(t, e) {
            ...
            a = i[1];
            let s = Buffer.from(a, 'base64').toString('ascii'),
              n = p.createHmac('md5', this._auth.credentials.pass);
            n.update(s);
            let o = this._auth.credentials.user + ' ' + n.digest('hex');
            this._responseActions.push((t) => {
              ...
              this._sendCommand(
                ...
                Buffer.from(
                  this._auth.credentials.user + ' /* secret */'
                ).toString('base64')
              );
          }
            ...
            if (
              (2 !== Number(t.charAt(0))
                ? ((i =
                  ...
                  this._envelope.rejected.push(s),
                  ((a = this._formatError(
                    i,
                    'EENVELOPE',
                    t,
                ...
                : this._envelope.accepted.push(s),
              this._envelope.rcptQueue.length || this._recipientQueue.length)
            )
              this._envelope.rcptQueue.length &&
                ((s = this._envelope.rcptQueue.shift()),
                this._recipientQueue.push(s),
                this._responseActions.push((t) => {
                  this._actionRCPT(t, e);
                }),
                this._sendCommand(
                  'RCPT TO:<' + s + '>' + this._getDsnRcptToArgs()
                ));
            else {
              if (!(this._envelope.rejected.length < this._envelope.to.length))
                return (
                  ...
                  (a.rejectedErrors = this._envelope.rejectedErrors),
                  e(a)
                );
              this._responseActions.push((t) => {
          ...
          _actionDATA(t, e) {
            ...
            this._ehloLines &&
              this._ehloLines.length &&
              (i.ehlo = this._ehloLines),
          ...
          _actionLMTPStream(t, e, i, a) {
            ...
            if (2 !== Number(i.charAt(0))) {
              ((s = this._formatError(
                ...
                this._envelope.rejectedErrors.push(s);
          ...
          _handleXOauth2Token(t, e) {
            this._auth.oauth2.getToken(t, (i, a) => {
              if (i)
                return (
                  this.logger.info(
                    {
        ...
        class c extends a {
          constructor(t) {
            ...
            'function' == typeof t.getSocket && (this.getSocket = t.getSocket),
              t.url &&
                ((e = r.parseConnectionUrl(t.url)), (i = i || e.service)),
              (this.options = r.assign(!1, t, e, i && o(i))),
              (this.options.maxConnections = this.options.maxConnections || 5),
              (this.options.maxMessages = this.options.maxMessages || 100),
              (this.logger = r.getLogger(this.options, {
                component: this.options.component || 'smtp-pool',
              }));
            let a = new n(this.options);
            (this.name = 'SMTP (pool)'),
              (this.version = p.version + '[client:' + a.version + ']'),
              (this._rateLimit = {
                counter: 0,
                timeout: null,
                waiting: [],
          ...
          send(t, e) {
            return (
              !this._closed &&
              (this._queue.push({ mail: t, requeueAttempts: 0, callback: e }),
              this.idling &&
          ...
          close() {
            let t;
            let e = this._connections.length;
            if (
              ((this._closed = !0),
            ...
            let i = () => {
              ...
              if (e && 'function' == typeof e.callback)
                try {
                  e.callback(Error('Connection pool was closed'));
                } catch (e) {
                  this.logger.error(
          ...
          _processMessages() {
            ...
            let a = (t.queueEntry = this._queue.shift());
            (a.messageId = (
              ...
              t.once('close', () => {
                this.logger.info(
                  ...
                  t.queueEntry
                    ? setTimeout(() => {
                        t.queueEntry &&
                          (this._shouldRequeuOnConnectionClose(t.queueEntry)
                            ? this._requeueEntryOnConnectionClose(t)
                            : this._failDeliveryOnConnectionClose(t)),
          ...
          _shouldRequeuOnConnectionClose(t) {
            return (
              void 0 === this.options.maxRequeues ||
              this.options.maxRequeues < 0 ||
              t.requeueAttempts < this.options.maxRequeues
            );
          }
          _failDeliveryOnConnectionClose(t) {
            if (t.queueEntry && t.queueEntry.callback) {
              try {
                t.queueEntry.callback(
                  Error(
          ...
          _requeueEntryOnConnectionClose(t) {
            (t.queueEntry.requeueAttempts = t.queueEntry.requeueAttempts + 1),
              this.logger.debug(
                {
                  tnx: 'pool',
                  cid: t.id,
          ...
          verify(t) {
            ...
            let i = new s(this).auth;
            return (
              this.getSocket(this.options, (e, a) => {
                if (e) return t(e);
                let s = this.options;
                a &&
                  a.connection &&
                  (this.logger.info(
                    {
                      ...
                      remotePort: a.connection.remotePort,
                      destHost: s.host || '',
                      destPort: s.port || '',
                      action: 'connected',
                    },
                ...
                let o = new n(s),
                  p = !1;
                o.once('error', (e) => {
                  if (!p) return (p = !0), o.close(), t(e);
                }),
                  o.once('end', () => {
                    if (!p) return (p = !0), t(Error('Connection closed'));
                  });
                let c = () => {
                  if (!p) return (p = !0), o.quit(), t(null, !0);
                };
                o.connect(() => {
                  if (!p) {
                    if (i && (o.allowsAuth || s.forceAuth))
                      o.login(i, (e) => {
                        if (!p) {
                          if (e) return (p = !0), o.close(), t(e);
                          c();
                        }
                      });
                    else if (!i && o.allowsAuth && s.forceAuth) {
                      let e = Error('Authentication info was not provided');
                      return (e.code = 'NoAuth'), (p = !0), o.close(), t(e);
                    } else c();
                  }
                });
              }),
      ...
      8926: (t, e, i) => {
        ...
        class r extends o {
          constructor(t) {
            if (
              ...
              switch ((this.options.auth.type || '').toString().toUpperCase()) {
                case 'OAUTH2': {
                  let t = new n(this.options.auth, this.logger);
                  (t.provisionCallback =
                    (this.pool.mailer &&
          ...
          connect(t) {
            this.pool.getSocket(this.options, (e, i) => {
              ...
              i &&
                ...
                (this.connection = new a(o)),
                this.connection.once('error', (e) => {
                  if ((this.emit('error', e), !n)) return (n = !0), t(e);
                }),
                this.connection.once('end', () => {
                  ...
                  let e = setTimeout(() => {
                    if (n) return;
                    let e = Error('Unexpected socket close');
                    this.connection &&
                ...
                this.connection.connect(() => {
                  if (!n) {
                    if (
                      !this.auth ||
                      (!this.connection.allowsAuth && !o.forceAuth)
                    )
                      return (n = !0), (this._connected = !0), t(null, !0);
                    this.connection.login(this.auth, (e) => {
                      if (!n) {
                        if (((n = !0), e))
                          return (
                            this.connection.close(), this.emit('error', e), t(e)
                          );
          ...
          send(t, e) {
            ...
            s.length > 3 && s.push('...and ' + s.splice(2).length + ' more'),
              this.logger.info(
                { tnx: 'send', messageId: a, cid: this.id },
              ...
              this.connection.send(i, t.message.createReadStream(), (t, s) => {
                if ((this.messages++, t))
                  return this.connection.close(), this.emit('error', t), e(t);
                (s.envelope = { from: i.from, to: i.to }),
                  (s.messageId = a),
                  setImmediate(() => {
                    let t;
                    this.messages >= this.options.maxMessages
                      ? (((t = Error('Resource exhausted')).code = 'EMAXLIMIT'),
      ...
      8662: (t, e, i) => {
        ...
        class c extends a {
          constructor(t) {
            ...
            'function' == typeof t.getSocket && (this.getSocket = t.getSocket),
              t.url &&
                ((e = o.parseConnectionUrl(t.url)), (i = i || e.service)),
              (this.options = o.assign(!1, t, e, i && n(i))),
              (this.logger = o.getLogger(this.options, {
                component: this.options.component || 'smtp-transport',
              }));
            let a = new s(this.options);
            (this.name = 'SMTP'),
              (this.version = p.version + '[client:' + a.version + ']'),
          ...
          getAuth(t) {
            ...
            if (
              ...
              return !1;
            if ('OAUTH2' === (i.type || '').toString().toUpperCase()) {
              if (!i.service && !i.user) return !1;
              let t = new r(i, this.logger);
              return (
                (t.provisionCallback =
            ...
            return {
              ...
              method:
                (i.method || '').trim().toUpperCase() ||
                this.options.authMethod ||
                !1,
            };
          }
          send(t, e) {
            this.getSocket(this.options, (i, a) => {
              if (i) return e(i);
              let n = !1,
                r = this.options;
              a &&
              ...
              p.once('error', (t) => {
                ...
                p.once('end', () => {
                  ...
                  let t = setTimeout(() => {
                    if (n) return;
                    n = !0;
                    let t = Error('Unexpected socket close');
                    p && p._socket && p._socket.upgrading && (t.code = 'ETLS'),
                      e(t);
                  }, 1e3);
                  try {
                    t.unref();
              ...
              let c = () => {
                let i = t.message.getEnvelope(),
                  ...
                  s = [].concat(i.to || []);
                s.length > 3 &&
                  s.push('...and ' + s.splice(2).length + ' more'),
                  t.data.dsn && (i.dsn = t.data.dsn),
                  this.logger.info(
                    { tnx: 'send', messageId: a },
                    'Sending message %s to <%s>',
                  ...
                  p.send(i, t.message.createReadStream(), (t, s) => {
                    if (((n = !0), p.close(), t))
                      return (
                        this.logger.error(
                          { err: t, tnx: 'send' },
            ...
            return (
              ...
              this.getSocket(this.options, (e, i) => {
                ...
                let n = new s(a),
                  r = !1;
                n.once('error', (e) => {
                  if (!r) return (r = !0), n.close(), t(e);
                }),
                  n.once('end', () => {
                    if (!r) return (r = !0), t(Error('Connection closed'));
                  });
                let p = () => {
                  if (!r) return (r = !0), n.quit(), t(null, !0);
                };
                n.connect(() => {
                  if (r) return;
                  let e = this.getAuth({});
                  if (e && (n.allowsAuth || a.forceAuth))
                    n.login(e, (e) => {
                      if (!r) {
                        if (e) return (r = !0), n.close(), t(e);
                        p();
                      }
                    });
                  else if (!e && n.allowsAuth && a.forceAuth) {
                    let e = Error('Authentication info was not provided');
                    return (e.code = 'NoAuth'), (r = !0), n.close(), t(e);
                  } else p();
                });
              }),
              e
          ...
          send(t, e) {
            ...
            s.length > 3 && s.push('...and ' + s.splice(2).length + ' more'),
              ...
              setImmediate(() => {
                ...
                i.on('readable', () => {
                  let t;
                  for (; null !== (t = i.read()); ) s.push(t), (n += t.length);
                }),
                  i.once(
                    'error',
                    (t) => (
      ...
      7797: (t, e, i) => {
        ...
        class r extends a {
          ...
          getToken(t, e) {
            ...
            this.provisionCallback
              ? this.provisionCallback(this.options.user, !!t, (t, e, a) => {
                  !t && e && ((this.accessToken = e), (this.expires = a || 0)),
                    i(t, e);
                })
            ...
            if (this.options.serviceClient) {
              let a,
                ...
                n = {
                  ...
                  iat: s,
                  exp: s + this.options.serviceRequestTimeout,
                };
              try {
                a = this.jwtSignRS256(n);
              } catch (e) {
                return t(
                  Error("Can't generate token. Check your auth options")
                );
              }
              (e = {
              ...
              if (!this.options.refreshToken)
                return t(Error("Can't create new access token for user"));
              (e = {
                ...
                (e, i) => {
                  ...
                  if (!a || 'object' != typeof a)
                    return (
                      ...
                      t(Error('Invalid authentication response'))
                    );
                  let s = {};
                  if (
                    (Object.keys(a).forEach((t) => {
                    ...
                    let e = a.error;
                    return (
                      a.error_description && (e += ': ' + a.error_description),
                      a.error_uri && (e += ' (' + a.error_uri + ')'),
                      t(Error(e))
                    );
                  }
                  return a.access_token
                    ? (this.updateToken(a.access_token, a.expires_in),
          ...
          buildXOAuth2Token(t) {
            ...
            return Buffer.from(e.join('\x01'), 'utf-8').toString('base64');
          }
          postRequest(t, e, i, a) {
            let n = !1,
              o = [],
            ...
            p.on('readable', () => {
              let t;
              for (; null !== (t = p.read()); ) o.push(t), (r += t.length);
            }),
              p.once('error', (t) => {
                if (!n) return (n = !0), a(t);
              }),
              p.once('end', () => {
                if (!n) return (n = !0), a(null, Buffer.concat(o, r));
              });
          }
          toBase64URL(t) {
            return (
