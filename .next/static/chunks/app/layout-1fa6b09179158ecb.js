(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [177],
  {
    2404: (e, t, r) => {
      Promise.resolve().then(r.bind(r, 53)),
        ...
        Promise.resolve().then(r.t.bind(r, 1480, 23)),
        Promise.resolve().then(r.t.bind(r, 502, 23));
    },
    6645: (e, t, r) => {
      'use strict';
      r.d(t, { default: () => l });
    ...
    7208: (e, t, r) => {
      ...
      let o = (e) => {
        let { children: t, ...r } = e;
        return (0, s.jsx)(a.N, { ...r, children: t });
      };
    },
    2905: (e, t, r) => {
      'use strict';
      ...
      let h = (0, f.F)(
        ...
        p = c.forwardRef((e, t) => {
          let { className: r, variant: a, size: o, asChild: n = !1, ...i } = e,
            d = n ? u.DX : 'button';
          return (0, s.jsx)(d, {
            className: (0, g.cn)(h({ variant: a, size: o, className: r })),
            ref: t,
            ...i,
          });
        });
      ...
      let m = () => 'theme toggle',
        ...
        A = function () {
          ...
          return { en: m, pl: x }[
            null !== (e = t.languageTag) && void 0 !== e ? e : (0, v.xw)()
          ]();
        },
        b = (e) => {
          let { className: t } = e,
            { theme: r, setTheme: o } = (0, a.D)();
          return (0, s.jsxs)(p, {
            className: t,
            variant: 'secondary',
            size: 'icon',
            'aria-label': A(),
            onClick: () => o('light' === r ? 'dark' : 'light'),
            children: [
              (0, s.jsx)(l.sun, { className: 'dark:hidden' }),
              (0, s.jsx)(l.moon, { className: 'hidden dark:block' }),
            ],
          });
        };
    },
    9020: (e, t, r) => {
      ...
      let u = (0, n.F)(
        ...
        f = a.forwardRef((e, t) => {
          ...
          return (0, s.jsx)(o.bL, {
            ref: t,
            className: (0, d.cn)(u({ variant: a }), r),
            ...n,
          });
        });
      ...
      g.displayName = o.bm.displayName;
      ...
      h.displayName = o.hE.displayName;
      ...
      let v = 0,
        ...
        x = (e) => {
          if (m.has(e)) return;
          let t = setTimeout(() => {
            m.delete(e), w({ type: 'REMOVE_TOAST', toastId: e });
          }, 1e6);
          m.set(e, t);
        },
        A = (e, t) => {
      ...
      function j(e) {
        let { ...t } = e,
          r = (v = (v + 1) % Number.MAX_SAFE_INTEGER).toString(),
    ...
    5940: (e, t, r) => {
      'use strict';
      let s;
      r.d(t, { ij: () => l, k_: () => a, tH: () => i, xw: () => n });
      let a = 'en',
        o = ['en', 'pl'],
        n = () => a,
        i = (e) => {
          (n = 'function' == typeof e ? d(e) : d(() => e)),
            void 0 !== s && s(n());
        };
      function d(e) {
        return () => {
  ...
  (e) => {
    var t = (t) => e((e.s = t));
    e.O(0, [523, 781, 767, 970, 465, 882, 441, 517, 358], () => t(2404)),
      (_N_E = e.O());
  },
]);
